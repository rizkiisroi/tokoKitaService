...
import com.alam.tokokitaservice.TokoKitaServiceApp;
...
@SpringBootTest(classes = TokoKitaServiceApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class TokoKitaServiceKafkaResourceIT {
    ...
    @Autowired
    private TokoKitaServiceKafkaProducer producer;

    @Autowired
    private TokoKitaServiceKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        TokoKitaServiceKafkaResource kafkaResource = new TokoKitaServiceKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/toko-kita-service-kafka/publish?message=test"))
